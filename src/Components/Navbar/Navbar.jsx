  ...
  return (
    <div className='navbar'>
      ...
      <ul ref={menuRef}className="nav-menu">
        ...
        <li onClick={()=>{setMenu("bns-to-ipc-convertor")}}><Link style={{textDecoration:'none'}} to='/bns-to-ipc-convertor'>BNS to IPC Convertor</Link>{menu==="bns-to-ipc-convertor"?<hr/>:<></>}</li>
